...
class Owner(models.Model):
    ...
    def __str__(self):
        return '<Id: {} City: {} Mail: {} Phone: {}>'\
            .format(self.national_id, self.city, self.mail if self.mail is not None else '---', self.phone if self.phone is not None else '---')
...
class OwnerProfile(models.Model):
    ...
    def __str__(self):
        return '<Id: {} Age: {} Education: {} Residence: {}/{} Loads: {}>'\
            .format(self.person.national_id, self.age, self.education_level, self.living_place_type, self.real_state_units, self.dependents)
...
class EconomicProfile(models.Model):
    ...
    def __str__(self):
        return '<Id: {} CreditCards: {} Balance: {} Average: {} CC_Balance: {}>'\
            .format(self.person.national_id, self.credit_cards, self.credit_balance, self.average_credit_balance, self.credit_card_balance)
